...
def ViewGrasps(vis, poses = None, grip_widths = None, name=None, freq=100):
    ...
    for i, pose in enumerate(poses):
        ...
        vis.view_cylinder(stick_len, stick_radius, X_pose = pose @ X_pose_cl1, name = f"scene/cl{i}1") #side stick
        vis.view_cylinder(stick_len, stick_radius, X_pose = pose @ X_pose_cl2, name = f"scene/cl{i}2") #side stick
        vis.view_cylinder(grip_width, stick_radius, X_pose = pose @ X_pose_cl3, name = f"scene/cl{i}3") #mid stick 
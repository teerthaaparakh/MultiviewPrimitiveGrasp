...
#     data_dict_keys = ["kpts", "center_kpts", "orientations", "widths",
#                       "scales", "grasp_indices", "category_ids", "bboxes"]
...
#             # mapper_dict["grasp_indices"].append(sampled_idx)
#         mapper_dict["kpts"].append(torch.from_numpy(object_dict["keypoints"]))
